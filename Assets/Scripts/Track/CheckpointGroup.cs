...
public class CheckpointGroup : MonoBehaviour
{
    ...
    public void Activate()
    {
        ...
        GameManager.OnCarResetStarted -= HandleCarResetStart;
        GameManager.OnCarResetStarted += HandleCarResetStart;

        GameManager.OnCarResetCompleted -= HandleCarResetcompleted;
        GameManager.OnCarResetCompleted += HandleCarResetcompleted;
    ...
    {
        _nextCheckpoint.HandleCarResetStart();
    }

    private void HandleCarResetcompleted()
    {
        _nextCheckpoint.HandleCarResetcomplete();
    }
